    ...
    <div className="service-container">
      <h1>Services</h1>
        <div className="main-services">
          <h1>DESIGN</h1>
          <img src="https://images.ctfassets.net/3s5io6mnxfqz/1LYm3ZMaDeA5lRPu53w9PT/6b73a5799e1f6044037a0bb8acf4f23c/AdobeStock_232427041.jpeg"/>
        </div>
        <div className="secondary-services">
          <h1 className='sec-img-1'>CONSTRUCTION</h1>
