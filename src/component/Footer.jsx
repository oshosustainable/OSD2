...
const Footer = () => {
  return (
    <>
    <div className="container" style={{width:"80%",padding:0}}>
        <footer className="py-5">
          <div className="row">
            <div className="col-6 col-md-4 mb-4">
              <h4>Contact info</h4>
              <ul className="nav flex-column">
                <li className="nav-item mb-2">Banasthali</li>
                <li className="nav-item mb-2">Kathmandu</li>
                <li className="nav-item mb-2">Nepal</li><br />
                <li className="nav-item mb-2">Phone: 9851246689</li>
                <li className="nav-item mb-2">Emali: osddevelopers@gmail.com</li>
              </ul>
            </div>
            ...
            <div className="col-8 col-md-4 mb-4">
              ...
              <ul className="list-unstyled d-flex mt-3">
                ...
                <li className="ms-3"><a className="link-primary" href="https://www.linkedin.com/in/suresh-paudyal-9304424b/" target='_blank'>
                ...
                <li className="ms-3"><a className="link-success" href="https://wa.me/9779851246689">
                ...
                <li className="ms-3"><a className="link-primary" href="https://www.facebook.com/profile.php?id=100054236540392" target='_blank'>
                ...
                <li className="ms-3"><a className="link-danger" href="https://www.instagram.com/suresh.p1/" target='_blank'>
          ...
          <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
            <p>&copy; 2025 Osho Sustainable Designers and Developers Pvt. Ltd.. All rights reserved.</p>
            <p>Designed by :<a href="https://www.linkedin.com/in/satish-mahat-410a11278/" target="_blank">Satish Mahat</a></p>
          </div>
        </footer>
      </div>
    </>
